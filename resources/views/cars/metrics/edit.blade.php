<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 dark:text-gray-200 leading-tight">
            {{ __('Edit Metric') }} - {{ $car->brand }} {{ $car->model }}
        </h2>
    </x-slot>
    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="sketchy-card bg-white dark:bg-gray-800 overflow-hidden">
                <div class="p-6">
                    <form action="{{ route('cars.metrics.update', [$car, $metric]) }}" method="POST" class="space-y-6">
                        @csrf
                        @method('PUT')
                        ...
                        <div>
                            ...
                            <x-text-input id="reading_date" 
                                         type="date" 
                                         name="reading_date"
                                         :value="old('reading_date', $metric->reading_date->format('Y-m-d'))"
                        ...
                        <div>
                            ...
                            <x-text-input id="odometer_reading" 
                                         ...
                                         :value="old('odometer_reading', $metric->odometer_reading)"
                                         class="mt-1 block w-full" 
                                         step="0.01"
                                         required />
                        ...
                        <div>
                            ...
                            <x-text-input id="fuel_amount" 
                                         type="number" 
                                         name="fuel_amount"
                                         :value="old('fuel_amount', $metric->fuel_amount)"
                                         class="mt-1 block w-full" 
                                         step="0.01"
                                         required />
                        ...
                        <div>
                            ...
                            <x-text-input id="fuel_cost" 
                                         type="number" 
                                         name="fuel_cost"
                                         :value="old('fuel_cost', $metric->fuel_cost)"
                                         class="mt-1 block w-full" 
                                         step="0.01"
                                         required />
                        ...
                        <div>
                            ...
                            <textarea id="notes"
                                      ...
                                      rows="3">{{ old('notes', $metric->notes) }}</textarea>
